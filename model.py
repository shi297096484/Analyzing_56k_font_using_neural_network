...
class Model(object):
    def __init__(self, n=None, k=62, wh=64*64, d=40, D=1024, lambd=1e-7, font_noise=0.03, artificial_font=False):
        ...
        if artificial_font:
            ...
            self.input_font_one_hot = input_font_one_hot
        ...
        for i in xrange(4):
            ...
            #network = batch_norm(lasagne.layers.DenseLayer(network, D, name='dense_%d' % i, nonlinearity=lasagne.nonlinearities.leaky_rectify))
    ...
    def get_train_fn(self):
        ...
        #updates = lasagne.updates.adam(self.loss_train + self.reg, params, learning_rate=learning_rate, beta1=0.9, beta2=0.999, epsilon=1e-08)
        #updates = lasagne.updates.rmsprop(self.loss_train + self.reg, params, learning_rate=learning_rate, rho=0.9, epsilon=1e-06)
        updates = lasagne.updates.adadelta(self.loss_train + self.reg, params, learning_rate=learning_rate, rho=0.95, epsilon=1e-06)
